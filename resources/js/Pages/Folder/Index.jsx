        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="container mx-auto px-4 py-6">
                <div className="flex flex-col items-center gap-4">
                    {folder?.folder_id ? <GoBackButton href={route('folders.show', folder.folder_id)} /> : <GoBackButton href={route('folders.index')} />}
                    {creatingFolder ?
                        <CreateNewFolder folder={folder} setCreatingFolder={setCreatingFolder} />
                        :
                        <Button className="w-full" variant="outline" onClick={(e) => setCreatingFolder(true)}>
